...
VALUES
    (1, "ImZardy", '$2y$10$QtCybkpkzh7x5VN11APHned4J8fu78.eFXlyAMmahuAaNcbwZ7FH.' , "'Im Zardy' is Armenian for My Jewelery. We are a group of talented and dedicated jewelers making unique jewelery that is rich with the juxdoposition of Armenian traditional and modern styles and references to Armenian culture and history. (Citation: This description originates from 'Im Zardy' official website/social media.)");

--- Insert Protest Handmade into jewelers table ---
INSERT INTO
    users (id, username, password , jeweler_description)
VALUES
    (2, "ProtestHandmade", '$2y$10$QtCybkpkzh7x5VN11APHned4J8fu78.eFXlyAMmahuAaNcbwZ7FH.' , "SILVER and LEATHER cool accessories with the best quality! Cause In such ugly times, the only true protest is beauty. (Citation: This description originates from 'Protest Handmade' official website/social media.) ");
